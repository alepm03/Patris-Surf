...
export default function Footer({ lang }: FooterProps) {
  ...
  return (
    <footer className="relative bg-white border-t border-slate-100 pt-20 pb-12 overflow-hidden" id="footer-container">
      ...
      <div className="absolute top-0 inset-x-0 h-[1px] bg-gradient-to-r from-transparent via-[#3de5bd]/15 to-transparent" />
          ...
          <div className="md:col-span-4 space-y-6">
            ...
            <div className="flex items-center space-x-3">
              <a
                ...
                className="w-10 h-10 rounded-none bg-slate-50 hover:bg-[#cdefe4]/40 border border-slate-200 hover:border-[#3de5bd] flex items-center justify-center text-slate-500 hover:text-[#020617] transition-all"
            ...
            <ul className="space-y-3">
              {current.col2Links.map((link, idx) => (
                <li key={idx}>
                  <a
                    href={link.href}
                    className="font-sans text-xs sm:text-sm text-slate-500 hover:text-[#3de5bd] transition-colors font-light"
                  >
                    {link.label}
                  </a>
                </li>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between pt-10 gap-6">
          <div className="flex flex-col items-start space-y-1.5 text-left select-none">
            ...
            <span className="font-sans text-[11px] text-slate-500 font-light flex items-center gap-1.5">
              <Heart className="w-3.5 h-3.5 text-[#3de5bd]" />
              {current.seal}
            </span>
          </div>
          ...
          <button
            ...
            className="group flex items-center space-x-2 px-5 py-3 rounded-none bg-slate-50 border border-slate-200 hover:border-slate-300 hover:bg-[#cdefe4]/40 text-slate-500 hover:text-[#020617] font-mono text-[10px] uppercase tracking-widest transition-all"
