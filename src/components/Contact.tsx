        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20 items-stretch">
                ...
                {!formSubmitted ? (
                  ...
                  >
                    <h3 className="font-display font-bold text-lg text-[#020617] mb-6 flex items-center gap-2 uppercase tracking-wide">
                      <Calendar className="w-5 h-5 text-[#3de5bd]" />
                    ...
                    <div className="flex flex-col text-left">
                      ...
                      <input
                        ...
                        className="px-4 py-3 bg-slate-50 border border-slate-200 rounded-none text-slate-800 font-sans text-sm focus:border-[#3de5bd] focus:bg-white focus:outline-none transition-all placeholder-slate-400"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      ...
                      <div className="flex flex-col text-left">
                        ...
                        <select
                          ...
                          className="px-4 py-3 bg-slate-50 border border-slate-200 rounded-none text-slate-800 font-sans text-xs focus:border-[#3de5bd] focus:bg-white focus:outline-none transition-all"
                        >
                      ...
                      <div className="flex flex-col text-left">
                        ...
                        <select
                          ...
                          className="px-4 py-3 bg-slate-50 border border-slate-200 rounded-none text-slate-850 font-sans text-xs focus:border-[#3de5bd] focus:bg-white focus:outline-none transition-all"
                        >
                    ...
                    <div className="flex flex-col text-left">
                      ...
                      <input
                        ...
                        className="px-4 py-3 bg-slate-50 border border-slate-200 rounded-none text-slate-800 font-sans text-sm focus:border-[#3de5bd] focus:bg-white focus:outline-none transition-all"
                      />
                    </div>
                    ...
                    <div className="flex flex-col text-left">
                      ...
                      <textarea
                        ...
                        className="px-4 py-3 bg-slate-50 border border-slate-200 rounded-none text-slate-800 font-sans text-sm focus:border-[#3de5bd] focus:bg-white focus:outline-none transition-all resize-none placeholder-slate-400"
                      />
                    </div>
                    ...
                    <button
                      type="submit"
                      className="w-full py-4 rounded-none bg-[#3de5bd] hover:bg-[#020617] text-[#020617] hover:text-white font-display font-medium text-xs tracking-widest uppercase transition-all flex items-center justify-center space-x-2 shadow-sm"
                    >
                  ...
                  >
                    <div className="w-16 h-16 border-2 border-[#3de5bd] rounded-full flex items-center justify-center mb-6 animate-bounce">
                      <CheckCircle2 className="w-10 h-10 text-[#3de5bd]" />
                    </div>
          ...
          <div className="lg:col-span-6 flex flex-col justify-between h-full">
            <div className="p-8 md:p-10 rounded-none bg-slate-50 border border-slate-200 flex flex-col justify-between h-full relative overflow-hidden">
              ...
              <div className="absolute top-4 right-4 z-20 font-mono text-[9px] text-[#3de5bd]/85 tracking-widest uppercase select-none">
              ...
              <div className="w-full aspect-[4/3] relative rounded-none bg-[#ffffff] border border-slate-200 overflow-hidden shadow-inner group">
                ...
                <div className="absolute inset-x-0 bottom-1/4 h-8 bg-gradient-to-t from-[#3de5bd]/15 to-transparent flex items-center justify-around overflow-hidden pointer-events-none">
                  <Waves className="w-4 h-4 text-[#3de5bd]/35 animate-pulse" />
                  <Waves className="w-4 h-4 text-[#3de5bd]/35 animate-pulse delay-200" />
                  <Waves className="w-4 h-4 text-[#3de5bd]/35 animate-pulse delay-500" />
                </div>
                ...
                <div className="absolute bottom-[35%] left-[60%] z-20 group/pin pointer-events-auto">
                  <div className="flex flex-col items-center">
                    ...
                    <span className="flex h-3.5 w-3.5 relative">
                      <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#3de5bd] opacity-75"></span>
                      <span className="relative inline-flex rounded-full h-3.5 w-3.5 bg-[#3de5bd] cursor-pointer"></span>
                    </span>
                  </div>
                </div>
                ...
                <div className="absolute bottom-[15%] left-[25%] z-20 group/pin pointer-events-auto">
                  <div className="flex flex-col items-center">
                    <span className="px-2.5 py-1 whitespace-nowrap bg-[#3de5bd] text-[#020617] font-mono text-[8px] font-bold uppercase rounded-none tracking-widest shadow opacity-0 group-hover/pin:opacity-100 transition-opacity translate-y-[-4px]">
                ...
                <div className="absolute top-[35%] left-[20%] z-20 group/pin pointer-events-auto">
                  <div className="flex flex-col items-center">
                    ...
                    <span className="flex h-3.5 w-3.5 relative">
                      <span className="relative inline-flex rounded-full h-3.5 w-3.5 bg-[#3de5bd]/50 cursor-pointer"></span>
                    </span>
                  </div>
                </div>
              ...
              <div className="mt-8 pt-6 border-t border-slate-200/80 space-y-4 text-left">
                <div className="flex items-center space-x-3 text-sm text-slate-700">
                  <Mail className="w-4 h-4 text-[#3de5bd] flex-shrink-0" />
                  <a href="mailto:patrissurf@gmail.com" className="hover:text-[#3de5bd] transition-colors font-sans">
                    patrissurf@gmail.com
                  </a>
                </div>
                <div className="flex items-center space-x-3 text-sm text-slate-700">
                  <Phone className="w-4 h-4 text-[#3de5bd] flex-shrink-0" />
                  <a href="tel:+34688734123" className="hover:text-[#3de5bd] transition-colors font-sans">
                    688 734 123
                  </a>
                </div>
                <div className="flex items-center space-x-3 text-sm text-slate-700">
                  <Instagram className="w-4 h-4 text-[#3de5bd] flex-shrink-0" />
                  <a
                    href="https://www.instagram.com/patrissurf"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="hover:text-[#3de5bd] transition-colors font-sans"
                  >
                    @patrissurf
                  </a>
                </div>
