    ...
    <section id="collaborations" className="relative py-24 md:py-32 bg-[#fafafc] border-t border-slate-100 overflow-hidden text-left">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
          ...
          <div className="lg:col-span-4 p-8 bg-white border border-slate-250 hover:border-[#38bdf8]/40 shadow-xs flex flex-col justify-between transition-all">
            <div className="space-y-4">
              <div className="p-3 bg-[#38bdf8]/10 border border-[#38bdf8]/20 text-[#38bdf8] inline-block">
            ...
            <div className="pt-8 border-t border-slate-100">
              <a
                href="#contact"
                className="inline-flex items-center gap-2 text-xs font-mono font-bold tracking-widest text-[#38bdf8] hover:text-[#020617] transition-colors uppercase"
              >
              ...
              >
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="font-mono text-[9px] text-[#38bdf8] font-bold tracking-widest uppercase pb-1.5 block">
                      {p.type}
                    </span>
